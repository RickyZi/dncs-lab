...
## Design Requirements
- Hosts 1-a and 1-b are in two subnets (*Hosts-A* and *Hosts-B*) that must be able to scale up to respectively 56 and 190 usable addresses
- Host 2-c is in a subnet (*Hub*) that needs to accommodate up to 352 usable addresses
